...
namespace OracuMundial2026.Web.Services
{
    ...
    {
        public const string StartMarker = "<!-- oracumundial2026:snapshots:start -->";
        public const string EndMarker = "<!-- oracumundial2026:snapshots:end -->";
        ...
        public async Task ExportAsync(CancellationToken ct = default)
        {
            ...
            var existing = File.Exists(readmePath) ? await File.ReadAllTextAsync(readmePath, ct) : "# Oráculo Mundial 2026";
        ...
        private string RepositoryRoot()
        {
            ...
            {
                if (File.Exists(Path.Combine(current.FullName, "OracuMundial2026.sln")))
        ...
        private static string TeamCell(string teamId, string teamName)
        {
            ...
            return string.IsNullOrWhiteSpace(flag)
                ? escaped
                : $"<img src=\"OracuMundial2026.Web/wwwroot/flags/4x3/{flag}.svg\" width=\"18\" alt=\"\"> {escaped}";
        }
