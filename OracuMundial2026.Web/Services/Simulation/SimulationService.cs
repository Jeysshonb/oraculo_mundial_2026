...
namespace OracuMundial2026.Web.Services.Simulation
{
    public class SimulationService
    {
        ...
        public SimulationService(OracuMundial2026DbContext db, PredictionService prediction, 
            SnapshotService snapshots, IOptions<OracuMundial2026Config> options)
        {
            _db = db;
