...
namespace OracuMundial2026.Web.Services
{
    public class ApiFootballService
    {
        ...
        public ApiFootballService(HttpClient httpClient, OracuMundial2026DbContext db, IOptions<OracuMundial2026Config> config, AvailabilityNewsService availability, PlayerImpactService? impact = null)
        {
