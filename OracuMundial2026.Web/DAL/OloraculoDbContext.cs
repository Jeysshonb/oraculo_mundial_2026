...
namespace OracuMundial2026.Web.DAL
{
    public class OracuMundial2026DbContext : DbContext
    {
        public OracuMundial2026DbContext(DbContextOptions<OracuMundial2026DbContext> options) : base(options)
        {
        }
